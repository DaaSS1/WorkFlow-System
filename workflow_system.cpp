...
public:
    ...
    Document(string name_author, string doc_name, string main_text) :
...
public:
    ...
    StoragePlace(int id_place, string name_department) :
        id_place(id_place),
...
public:
    ...
    WorkGroup(int id, const string& name, const string& composition) :
        id_group(id),
        group_name(name),
...
public:
    ...
    WorkDoc(string name_author, string doc_name, string main_text,
           ...
           int id_group, string group_name, string composition) :
        Document(name_author, doc_name, main_text),
...
public:
    ...
    OrgDoc(string doc_name, int d_num, bool saining, bool signing, string d_status) :
        Document("", doc_name, ""),
        doc_num(d_num),
        saining(saining),
        signing(signing),
...
public:
    ...
    User(int id_user, string full_name, string role) :
        id_user(id_user),
        full_name(full_name),
